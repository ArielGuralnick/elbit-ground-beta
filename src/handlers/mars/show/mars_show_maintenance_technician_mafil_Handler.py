...
async def mars_show_maintenance_technician_mafil_Handler(request):
...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('app/templates/mars/show/mars_show_maintenance_technician_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' + '\n' + r"</form>" + '\n' + r"</section>" + '\n' +
...
{% endblock %}'''])
            f.close()
        return render_template('mars/show/mars_show_maintenance_technician_mafil.html')
        ...
        if request.form.get("options") == 'option_add':
            ...
            if date_upload == "" or disparity == "" :
                ...
                sys.stdout.flush()
                with open('app/db/mars/maintenance.csv', 'a', newline='', encoding='utf-8-sig') as file:
            ...
            src_upload_file_path = "app/db/mars/maintenance.csv"
