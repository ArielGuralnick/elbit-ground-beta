...
<form action="" method="post">''')       
      with open('elbit-ground-beta/app/templates/mars/edit/mars_edit_work_plan_mafil.html','w', encoding='utf-8-sig') as f:
        f.writelines([dphtml + '\n' + r'''
<div class="container">
<div class="row">
  ...
  <form method="POST">
    ...
    <button type="sumbit" name="options" value="option_delet" class="btn btn-outline-danger" onclick="fireDeletAlert()">מחיקה</button>
      ...
      if request.form.get('options') == 'option_edit':
        ...
        with open('elbit-ground-beta/app/db/mars/work_plan_mafil.csv', 'w', newline='', encoding='utf-8-sig') as file:
