...
async def mars_feedback_Handler(request):
    answer_1 = None
    answer_2 = None
    answer_3 = None
    answer_4 = None
    ...
    if request.method == 'GET':
        ...
        sys.stdout.flush()
        with open('app/db/mars/feedback.csv', 'a', newline='', encoding='utf-8-sig') as file:
        ...
        src_upload_file_path = "app/db/mars/feedback.csv"
