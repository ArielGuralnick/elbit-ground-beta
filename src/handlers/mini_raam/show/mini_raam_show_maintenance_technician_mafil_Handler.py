...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('app/templates/mini_raam/show/mini_raam_show_maintenance_technician_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' + '\n' + r"</form>" + '\n' + r"</section>" + '\n' +
...
{% endblock %}'''])
            f.close()
        return render_template('mini_raam/show/mini_raam_show_maintenance_technician_mafil.html')
