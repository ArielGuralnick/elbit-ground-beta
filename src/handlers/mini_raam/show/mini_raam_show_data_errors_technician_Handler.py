...
async def mini_raam_show_data_errors_technician_Handler(request):
    if request.method == 'GET':      
        data_errors = pd.read_csv('elbit-ground-beta/app/db/mini_raam/data_errors.csv')
        dphtml = (r'''
{% extends 'layout.html' %}
{% block content %}
...
<form action="" method="post">''')  
        ...
        with open('elbit-ground-beta/app/templates/mini_raam/show/mini_raam_show_data_errors_technician.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' +'\n' +
           r'''
<div class="container">
