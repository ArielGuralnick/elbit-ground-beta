...
<form action="" method="post">''')       
      with open('app/templates/mini_raam/edit/mini_raam_edit_warehouse_inventory.html','w', encoding='utf-8-sig') as f:
        f.writelines([dphtml + '\n' + r'''
...
<div class="col form-group" style="text-align: center;">
  <form method="POST">
    ...
    <button type="sumbit" class="btn btn-outline-dark btn-phone" name="options" value="option_back">לדשבורד</button>
        ...
        f.close()
      return render_template('mini_raam/edit/mini_raam_edit_warehouse_inventory.html', data = type_of_item)
