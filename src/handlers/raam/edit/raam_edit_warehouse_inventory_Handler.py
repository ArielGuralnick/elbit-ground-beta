...
async def raam_edit_warehouse_inventory_Handler(request):
...
<div>
  ...
  <h1 style="margin-left: 15%;">עריכת מחסן מיני רעם</h1>
</div>
</section>
<body style="background-color: rgb(211, 218, 218);">
<section id="show_data_errors" dir="rtl" lang="he">
<form action="" method="post">''')       
      with open('app/templates/raam/edit/raam_edit_warehouse_inventory.html','w', encoding='utf-8-sig') as f:
        f.writelines([dphtml + '\n' + r'''
...
<div class="col form-group" style="text-align: center;">
  <form method="POST">
    ...
    <button type="sumbit" class="btn btn-outline-dark btn-phone" name="options" value="option_back">לדשבורד</button>
        ...
        f.close()
      return render_template('raam/edit/raam_edit_warehouse_inventory.html', data = type_of_item)
      ...
      if request.form.get('options') == 'option_edit':
        ...
        sys.stdout.flush()
        with open('app/db/raam/warehouse_inventory.csv', 'w', newline='', encoding='utf-8-sig') as file:
