...
<form action="" method="post">''')       
      with open('app/templates/raam/edit/raam_edit_data_errors.html','w', encoding='utf-8-sig') as f:
        f.writelines([dphtml + '\n' + r'''
...
{% endblock %}'''])
        f.close()
      return render_template('raam/edit/raam_edit_data_errors.html', data = error)
