...
async def raam_edit_maintenance_technician_mafil_Handler(request):
...
<form action="" method="post">''')       
      with open('app/templates/raam/edit/raam_edit_maintenance_mafil.html','w', encoding='utf-8-sig') as f:
        f.writelines([dphtml + '\n' + r'''
...
<div class="col form-group" style="text-align: center;">
  <form method="POST">
    ...
    <button type="sumbit" class="btn btn-outline-dark btn-phone" name="options" value="option_back">לדשבורד</button>
        ...
        f.close()
      return render_template('raam/edit/raam_edit_maintenance_mafil.html', data = disparity)
      ...
      if request.form.get('options') == 'option_edit':
        ...
        sys.stdout.flush()
        with open('app/db/raam/maintenance.csv', 'w', newline='', encoding='utf-8-sig') as file:
