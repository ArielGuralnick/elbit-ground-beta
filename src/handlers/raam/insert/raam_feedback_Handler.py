...
async def raam_feedback_Handler(request):
    answer_1 = None
    answer_2 = None
    answer_3 = None
    answer_4 = None
    ...
    if request.method == 'GET':
        return render_template('feedback.html', title_simulator = "משוב מאמן רעם")
        ...
        sys.stdout.flush()
        with open('app/db/raam/feedback.csv', 'a', newline='', encoding='utf-8-sig') as file:
        ...
        src_upload_file_path = "app/db/raam/feedback.csv"
