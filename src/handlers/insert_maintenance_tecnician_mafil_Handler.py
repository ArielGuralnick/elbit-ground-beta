...
async def insert_maintenance_technician_mafil_Handler(request):
    if request.method == 'GET':
        return render_template('insert_maintenance_technician_mafil.html')
        ...
        with open('elbit-ground-beta/app/db/maintenance.csv', 'a', newline='', encoding='utf-8-sig') as file:
