...
<div>
  ...
  <h1 style="padding-left: 16%;">פערי מאמן</h1>
</div>
</section>
...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('app/templates/skyLark/show/show_maintenance_technician_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' + '\n' + r"</form>" + '\n' + r"</section>" + '\n' +
...
{% endblock %}'''])
            f.close()
        return render_template('skyLark/show/show_maintenance_technician_mafil.html')
        ...
        if request.form.get("options") == 'option_add':
            ...
            if date_upload == "" or disparity == "" :
                ...
                with open('app/db/skyLark/maintenance.csv', 'a', newline='', encoding='utf-8-sig') as file:
