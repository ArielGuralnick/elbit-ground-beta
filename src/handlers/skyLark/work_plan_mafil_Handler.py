...
async def work_plan_mafil_Handler(request):
...
{% endblock %}'''])
        ...
        if request.form.get("options") == 'option_add':
            ...
            with open('elbit-ground-beta/app/db/work_plan_mafil.csv', 'a', newline='', encoding='utf-8-sig') as file:
            ...
            return redirect(url_for('work_plan_mafil'))
