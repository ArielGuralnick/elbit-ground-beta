...
async def driving_show_data_activity_Handler(request):
    if request.method == 'GET':       
        data_activity = pd.read_csv('app/db/driving/data_activity.csv')
...
<div class="row">
    ...
    <form method="POST">
        ...
        with open('app/templates/driving/show/driving_show_data_activity.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' + '\n' +
            r"</form>" + '\n' + r"</section>" + '\n' + 
