...
<form action="" method="post">''') 
        ...
        dphtml += data_errors.to_html(table_id="driving_show_data_errors_mafil", classes = "table table-see-all-errors table-hover", border=0)
...
<div class="col form-group" style="text-align: center;">
    <form method="POST">
        ...
        <button type="sumbit" class="btn btn-outline-secondary btn-phone" name="options" value="option3">דוח אקסל</button>
