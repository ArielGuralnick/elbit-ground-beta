...
async def driving_show_tasks_mafil_Handler(request):
...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('app/templates/driving/show/driving_show_tasks_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>'  + '\n' + r'</section>' + '\n' + 
...
{% endblock %}'''])
            f.close()
        return render_template('driving/show/driving_show_tasks_mafil.html')
        ...
        if request.form.get("options") == 'option_add':
            ...
            if subject == "" or goal == "" or achievements =="" or responsible =="":
                ...
                sys.stdout.flush()
                with open('app/db/driving/tasks.csv', 'a', newline='', encoding='utf-8-sig') as file:
            ...
            return redirect(url_for('driving_edit_tasks_mafil'))
