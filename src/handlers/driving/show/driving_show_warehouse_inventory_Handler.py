...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('app/templates/driving/show/driving_show_warehouse_inventory.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>'  + '\n' + r'</section>' + '\n' + 
...
{% endblock %}'''])
        ...
        if request.form.get("options") == 'option_add':
            ...
            if type_of_item == "" or model == "" or quantity =="" :
                ...
                sys.stdout.flush()
                with open('app/db/driving/warehouse_inventory.csv', 'a', newline='', encoding='utf-8-sig') as file:
            ...
            src_upload_file_path = "app/db/driving/warehouse_inventory.csv"
