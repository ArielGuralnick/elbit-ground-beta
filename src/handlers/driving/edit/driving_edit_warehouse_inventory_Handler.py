...
async def driving_edit_warehouse_inventory_Handler(request):
...
<form action="" method="post">''')       
      with open('elbit-ground-beta/app/templates/driving/edit/driving_edit_warehouse_inventory.html','w', encoding='utf-8-sig') as f:
        f.writelines([dphtml + '\n' + r'''
...
<div class="col form-group" style="text-align: center;">
  <form method="POST">
    ...
    <button type="sumbit" name="options" value="option_delet" class="btn btn-outline-danger">מחיקה</button>
        ...
        f.close()
      return render_template('driving/edit/driving_edit_warehouse_inventory.html', data = type_of_item)
      ...
      if request.form.get('options') == 'option_edit':
        ...
        with open('elbit-ground-beta/app/db/driving/warehouse_inventory.csv', 'w', newline='', encoding='utf-8-sig') as file:
