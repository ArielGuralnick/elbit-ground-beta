...
<div>
  ...
  <h1>עריכת מחסן מורשת</h1>
</div>
</section>
<body style="background-color: rgb(211, 218, 218);">
<section id="show_data_errors" dir="rtl" lang="he">
<form action="" method="post">''')       
      with open('elbit-ground-beta/app/templates/moreshet/edit/moreshet_edit_warehouse_inventory.html','w', encoding='utf-8-sig') as f:
        f.writelines([dphtml + '\n' + r'''
<div class="container">
<div class="row">
  ...
  <form method="POST">
    ...
    <button type="sumbit" name="options" value="option_delet" class="btn btn-outline-danger">מחיקה</button>
      ...
      if request.form.get('options') == 'option_edit':
        ...
        with open('elbit-ground-beta/app/db/moreshet/warehouse_inventory.csv', 'w', newline='', encoding='utf-8-sig') as file:
