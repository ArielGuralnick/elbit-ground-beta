...
<div>
  ...
  <h1 style="margin-left: 15%;">עריכת מחסן שדר חם</h1>
</div>
</section>
<body style="background-color: rgb(211, 218, 218);">
<section id="show_data_errors" dir="rtl" lang="he">
<form action="" method="post">''')       
      with open('app/templates/sheder/edit/sheder_edit_warehouse_inventory.html','w', encoding='utf-8-sig') as f:
        f.writelines([dphtml + '\n' + r'''
  ...
  <form method="POST">
    ...
    <button type="sumbit" class="btn btn-outline-dark btn-phone" name="options" value="option_back">לדשבורד</button>
      ...
      if request.form.get('options') == 'option_edit':
        ...
        sys.stdout.flush()
        with open('app/db/sheder/warehouse_inventory.csv', 'w', newline='', encoding='utf-8-sig') as file:
            data.to_csv(file, index=False, na_rep='N/A',header=file.tell()==0, encoding='utf-8-sig')
            flash(f'!השורה עודכנה בהצלחה', category="success")
        
        src_upload_file_path = "app/db/sheder/warehouse_inventory.csv"
