...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('elbit-ground-beta/app/templates/sheder/show/sheder_show_maintenance_technician_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' + '\n' + r"</form>" + '\n' + r"</section>" + '\n' +
...
{% endblock %}'''])
        ...
        if request.form.get("options") == 'option_add':
            ...
            if date_upload == "" or disparity == "" :
                ...
                with open('elbit-ground-beta/app/db/sheder/maintenance.csv', 'a', newline='', encoding='utf-8-sig') as file:
