...
async def sheder_show_data_errors_mafil_Handler(request):
...
<form action="" method="post">''')        
        ...
        with open('elbit-ground-beta/app/templates/sheder/show/sheder_show_data_errors_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>'  + '\n' + r"</form>",r"</section>",
            r'''
<div class="container">
...
$('#sheder_show_data_errors_mafil').DataTable();
</script>"
</body>
{% endblock %}'''])
            f.close()
        return render_template('sheder/show/sheder_show_data_errors_mafil.html')
