...
async def sheder_show_data_errors_technician_Handler(request):
    if request.method == 'GET':       
        data_errors = pd.read_csv('app/db/sheder/data_errors.csv')
...
<form action="" method="post">''')  
        ...
        dphtml += data_errors.to_html(table_id="sheder_show_data_errors_technician", classes = "table table-see-all-errors table-hover", border=0)
        with open('app/templates/sheder/show/sheder_show_data_errors_technician.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' +'\n' +
            r'''
<div class="container">
