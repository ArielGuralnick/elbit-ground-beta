...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('app/templates/tzevet/show/tzevet_show_maintenance_technician_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' + '\n' + r"</form>" + '\n' + r"</section>" + '\n' +
...
{% endblock %}'''])
        ...
        if request.form.get("options") == 'option_add':
            ...
            if date_upload == "" or disparity == "" :
                ...
                field_content = ['מאמן','מספר מאמן','תאריך','מה הפער','טופל / לא טופל','תאריך טיפול']
                data_errors = pd.DataFrame([{'מאמן' : type_of_simulator, 'מספר מאמן' : type_of_cell,'תאריך' : date_upload,
                ...
                sys.stdout.flush()
                with open('app/db/tzevet/maintenance.csv', 'a', newline='', encoding='utf-8-sig') as file:
            ...
            src_upload_file_path = "app/db/tzevet/maintenance.csv"
