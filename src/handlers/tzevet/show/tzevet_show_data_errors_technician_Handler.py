...
async def tzevet_show_data_errors_technician_Handler(request):
    if request.method == 'GET':       
        data_errors = pd.read_csv('elbit-ground-beta/app/db/tzevet/data_errors.csv')
...
<form action="" method="post">''')  
        ...
        with open('elbit-ground-beta/app/templates/tzevet/show/tzevet_show_data_errors_technician.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' +'\n' +
            r'''
<div class="container">
