...
async def tzevet_feedback_Handler(request):
    ...
    if request.method == 'GET':
        return render_template('tzevet/tzevet_feedback.html', title_simulator = "מאמני צוות")
        ...
        with open('elbit-ground-beta/app/db/tzevet/feedback.csv', 'a', newline='', encoding='utf-8-sig') as file:
