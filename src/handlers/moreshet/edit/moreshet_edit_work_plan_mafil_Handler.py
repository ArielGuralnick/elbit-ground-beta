...
async def moreshet_edit_work_plan_mafil_Handler(request):
...
<form action="" method="post">''')       
      with open('app/templates/moreshet/edit/moreshet_edit_work_plan_mafil.html','w', encoding='utf-8-sig') as f:
        f.writelines([dphtml + '\n' + r'''
<div class="container">
<div class="row">
...
<div class="col form-group" style="text-align: center;">
  <form method="POST">
    ...
    <button type="sumbit" name="options" value="option_delet" class="btn btn-outline-danger" onclick="fireDeletAlert()">מחיקה</button>
        ...
        f.close()
      return render_template('moreshet/edit/moreshet_edit_work_plan_mafil.html', data = achievements)
      ...
      if request.form.get('options') == 'option_edit':
        ...
        sys.stdout.flush()
        with open('app/db/moreshet/work_plan_mafil.csv', 'w', newline='', encoding='utf-8-sig') as file:
