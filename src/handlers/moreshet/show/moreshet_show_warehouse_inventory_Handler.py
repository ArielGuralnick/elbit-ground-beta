...
<div>
  ...
  <h1 style="padding-left: 15%;">מלאי מחסן</h1>
</div>
</section>
<body style="background-color: rgb(211, 218, 218);">
<section id="show_data_errors" dir="rtl" lang="he">''')
        dphtml += data.to_html(classes = "table table-hover", border=0, index=False)
        with open('app/templates/moreshet/show/moreshet_show_warehouse_inventory.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>'  + '\n' + r'</section>' + '\n' + 
...
{% endblock %}'''])
        ...
        if request.form.get("options") == 'option_add':
            ...
            if type_of_item == "" or model == "" or quantity =="" :
                ...
                with open('app/db/moreshet/warehouse_inventory.csv', 'a', newline='', encoding='utf-8-sig') as file:
            ...
            return redirect(url_for('moreshet_technician'))