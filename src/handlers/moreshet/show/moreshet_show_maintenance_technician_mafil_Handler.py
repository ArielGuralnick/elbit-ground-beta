...
async def moreshet_show_maintenance_technician_mafil_Handler(request):
    ...
    if request.method == 'GET':
        data = pd.read_csv('app/db/moreshet/maintenance.csv')
        dphtml = (r'''
{% extends 'layout.html' %}
{% block content %}
...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('app/templates/moreshet/show/moreshet_show_maintenance_technician_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>' + '\n' + r"</form>" + '\n' + r"</section>" + '\n' +
...
{% endblock %}'''])
        ...
        if request.form.get("options") == 'option_add':
            ...
            if date_upload == "" or disparity == "" :
                ...
                sys.stdout.flush()
                with open('app/db/moreshet/maintenance.csv', 'a', newline='', encoding='utf-8-sig') as file:
            ...
            src_upload_file_path = "app/db/moreshet/maintenance.csv"
