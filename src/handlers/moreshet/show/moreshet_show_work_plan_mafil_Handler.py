...
async def moreshet_show_work_plan_mafil_Handler(request):
    ...
    if request.method == 'GET':
        data = pd.read_csv('elbit-ground-beta/app/db/moreshet/work_plan_mafil.csv')
        dphtml = (r'''
{% extends 'layout.html' %}
{% block content %}
...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('elbit-ground-beta/app/templates/moreshet/show/moreshet_show_work_plan_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>'  + '\n' + r'</section>' + '\n' + 
...
{% endblock %}'''])
        ...
        if request.form.get("options") == 'option_add':
            ...
            if subject == "" or goal == "" or achievements =="" or responsible =="":
                ...
                with open('elbit-ground-beta/app/db/moreshet/work_plan_mafil.csv', 'a', newline='', encoding='utf-8-sig') as file:
