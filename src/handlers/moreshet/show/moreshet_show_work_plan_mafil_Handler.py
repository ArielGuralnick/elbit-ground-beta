...
async def moreshet_show_work_plan_mafil_Handler(request):

    if request.method == 'GET':
        data = pd.read_csv('app/db/moreshet/work_plan_mafil.csv')
        dphtml = (r'''
{% extends 'layout.html' %}
{% block content %}
...
<section id="show_data_errors" dir="rtl" lang="he">''')
        ...
        with open('app/templates/moreshet/show/moreshet_show_work_plan_mafil.html','w', encoding='utf-8-sig') as f:
            f.writelines([dphtml + '\n' + r'<br>'  + '\n' + r'</section>' + '\n' + 
...
{% endblock %}'''])
            f.close()
        return render_template('moreshet/show/moreshet_show_work_plan_mafil.html')
        ...
        if request.form.get("options") == 'option_add':
            ...
            if subject == "" or goal == "" or achievements =="" or responsible =="":
                ...
                sys.stdout.flush()
                with open('app/db/moreshet/work_plan_mafil.csv', 'a', newline='', encoding='utf-8-sig') as file:
            ...
            src_upload_file_path = "app/db/moreshet/work_plan_mafil.csv"
            ...
            return redirect(url_for('moreshet_show_work_plan_mafil'))

        elif request.form.get("options") == 'option_edit':
            return redirect(url_for('moreshet_edit_work_plan_mafil'))