 ...
 *   https://datatables.net/download/#bs5-5.0.1/dt-1.11.3/r-2.2.9/rg-1.1.4/sc-2.0.5/sp-1.4.0
 *
 * Included libraries:
 *   Bootstrap 5 5.0.1, DataTables 1.11.3, Responsive 2.2.9, RowGroup 1.1.4, Scroller 2.0.5, SearchPanes 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5-5.0.1/dt-1.11.3/r-2.2.9/rg-1.1.4/sc-2.0.5/sp-1.4.0",
